...
class Network1(nn.Module):
    ...
    def __init__(self, init_weights=False):
        ...
        self.name = "Net1_v3.4_lsm2mpu"

        # Inputs = 9; Outputs = 3; Hidden = (3 layers) 20, 30 ,10
        self.fc_y1 = nn.Linear(9, 7) 
        self.fc_y2 = nn.Linear(7, 5)  
        self.fc_y3 = nn.Linear(5, 3) 
        self.fc_y4 = nn.Linear(3, 1)

        self.fc_p1 = nn.Linear(9, 7)   
        self.fc_p2 = nn.Linear(7, 5)  
        self.fc_p3 = nn.Linear(5, 3) 
        self.fc_p4 = nn.Linear(3, 1)

        self.fc_r1 = nn.Linear(9, 7) 
        self.fc_r2 = nn.Linear(7, 5)  
        self.fc_r3 = nn.Linear(5, 3) 
        self.fc_r4 = nn.Linear(3, 1)
