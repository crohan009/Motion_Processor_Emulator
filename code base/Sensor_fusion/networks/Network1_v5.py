...
class Network1(nn.Module):
    ...
    def __init__(self, init_weights=False):
        ...
        self.fc1 = nn.Linear(9, 9)  #   <- input layer
        self.fc2 = nn.Linear(9, 8)  #   -
        self.fc3 = nn.Linear(8, 8)  #    |  
        self.fc4 = nn.Linear(8, 7)  #    |  
        self.fc5 = nn.Linear(7, 7)  #    | 
        self.fc6 = nn.Linear(7, 6)  #    | 
        self.fc7 = nn.Linear(6, 6)  #    |- hidden layers
        self.fc8 = nn.Linear(6, 5)  #    | 
        self.fc9 = nn.Linear(5, 5)  #    |
        self.fc10 = nn.Linear(5, 4) #    |
        self.fc11 = nn.Linear(4, 4) #    |
        self.fc12 = nn.Linear(4, 3) #   -
