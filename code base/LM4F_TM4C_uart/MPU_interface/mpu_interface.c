...
void mpu_get_euler(EulerAngles_outputs *angles)
{
    long data[3];
  int i;
  inv_get_sensor_type_euler(data, &angles->accuracy, (inv_time_t*)(&angles->timestamp));
  double n = (1.0)*(1<<16);
//#define DEG2RAD 0.0174532925199433
  for (i=0; i<3; i++) angles->angles[i] = data[i] * 1.0/n ; //* DEG2RAD;        // returns angles[0] == pitch, angles[1] == roll, angles[2] == yaw
}
