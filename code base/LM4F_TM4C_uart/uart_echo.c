...
//float m_Res = 1200./4096.;         // Conversion from 1229 microTesla full scale (4096) to 12.29 Gauss full scale
...
//    UARTprintf("Hi\r\n");
    ...
    while (1) {
        ...
        int data_updated = mpu_update(&mpu_mpl_outputs);    // reads MPU-9159
//        read_scaled_imu_data(&b);                           // reads LSM
//
  //        b.acc1_data[0], b.acc1_data[1], b.acc1_data[2], b.gyro_data[0], b.gyro_data[1], b.gyro_data[2],  b.mag_data[0],  b.mag_data[1], b.mag_data[2]
...
//        mx = (float)mpu_mpl_outputs.mag[0]*m_Res*magCalibration[0] - magbias[0];  // get actual magnetometer value, this depends on scale being set
//        my = (float)mpu_mpl_outputs.mag[1]*m_Res*magCalibration[1] - magbias[1];
//        mz = (float)mpu_mpl_outputs.mag[2]*m_Res*magCalibration[2] - magbias[2];
...
//        print_float(b.acc1_data[2]);
//        UARTprintf("\t");
//        print_float(b.gyro_data[0] * PI/180);
//        UARTprintf("\t");
//        print_float(b.gyro_data[1] * PI/180);
//        UARTprintf("\t");
//        print_float(b.gyro_data[2] * PI/180);
//        UARTprintf("\t");
//        print_float(b.mag_data[0] * 100);
//        UARTprintf("\t");
