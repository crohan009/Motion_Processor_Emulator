...
//
    ...
    while (1) {
        ...
        MadgwickQuaternionUpdate(b.acc1_data[0], b.acc1_data[1], b.acc1_data[2], b.gyro_data[0]*PI/180.0f, b.gyro_data[1]*PI/180.0f, b.gyro_data[2]*PI/180.0f,  b.mag_data[0],  b.mag_data[1], b.mag_data[2], LSM_9DS0);
